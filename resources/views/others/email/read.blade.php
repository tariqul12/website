...
<div class="container-fluid">
    ...
    @include('layouts.shared.page-title' , ['title' => 'Email Read','subtitle' => 'Email'])
                    ...
                    <div class="inbox-rightbar">
                        ...
                        <div class="mt-4">
                            ...
                            <div class="d-flex align-items-start mb-3 mt-1">
                                <img class="d-flex me-2 rounded-circle" src="/images/users/user-2.jpg" alt="placeholder image" height="32">
                                <div class="w-100">
