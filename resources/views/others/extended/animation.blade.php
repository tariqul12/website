...
@section('css')
    @vite(['node_modules/animate.css/animate.compat.css'])
@endsection
...
@section('content')
    ...
    <div class="container-fluid">
        ...
        @include('layouts.shared.page-title' , ['title' => 'Animation','subtitle' => 'Extended UI'])
                    ...
                    <div class="card-body">
                        ...
                        <div class="text-center">
                            <div id="animationSandbox">
                                <img src="/images/macbook.png" alt="" class="img-fluid center-block">
                            </div>
                        </div>
