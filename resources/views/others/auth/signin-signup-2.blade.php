            ...
            <div class="card-body">
                ...
                <div class="tab-content">
                    <div class="tab-pane show active" id="tab-login">
                        ...
                        <form action="#">
                            ...
                            <div class="mb-3">
                                <a href="{{ route('second', ['auth', 'recoverpw-2']) }}"
                    ...
                    <div class="tab-pane" id="tab-signup">
                        <p class="text-muted mb-3">Don't have an account? Create your account, it takes less than a
                            minute</p>
                ...
                <footer class="footer footer-alt">
                    <p class="text-muted">2015 -
                        ...
                        </script> &copy; UBold theme by <a href="javascript: void(0);"
                                                           class="text-muted">Coderthemes</a>
                    </p>
                </footer>
