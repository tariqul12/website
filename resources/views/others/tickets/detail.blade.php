...
<div class="container-fluid">
    ...
    @include('layouts.shared.page-title' , ['title' => 'Ticket Detail','subtitle' => 'Apps'])
        ...
        <div class="col-xl-8 col-lg-7">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="d-flex align-items-start">
                                <img src="/images/users/user-2.jpg" alt="Arya S" class="rounded-circle me-2" height="24" />
                                <div class="w-100">
                                    <p> Thelma Fridley </p>
                                </div>
                            </div>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-start">
                        <img class="me-2 rounded-circle" src="/images/users/user-9.jpg" alt="Generic placeholder image" height="32">
                        <div class="w-100">
                    ...
                    <div class="d-flex align-items-start mt-3">
                        <img class="me-2 rounded-circle" src="/images/users/user-2.jpg" alt="Generic placeholder image" height="32">
                        <div class="w-100">
                    ...
                    <div class="d-flex align-items-start mt-3">
                        <a class="pe-2" href="#">
                            <img src="/images/users/user-9.jpg" class="rounded-circle" alt="Generic placeholder image" height="32">
                        </a>
                        <div class="w-100">
