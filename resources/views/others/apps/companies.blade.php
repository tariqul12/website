...
<div class="container-fluid">
    ...
    @include('layouts.shared.page-title' , ['title' => 'Companies','subtitle' => 'Apps'])
    ...
    <div class="row">
            ...
            <div class="card bg-pattern">
                <div class="card-body">
                    <div class="text-center">
                        <img src="/images/companies/amazon.png" alt="logo" class="avatar-xl rounded-circle mb-3">
        ...
        <div class="col-lg-4">
            <div class="card bg-pattern">
                <div class="card-body">
                    <div class="text-center">
                        <img src="/images/companies/apple.png" alt="logo" class="avatar-xl rounded-circle mb-3">
        ...
        <div class="col-lg-4">
            <div class="card bg-pattern">
                <div class="card-body">
                    <div class="text-center">
                        <img src="/images/companies/google.png" alt="logo" class="avatar-xl rounded-circle mb-3">
    ...
    <div class="row">
        <div class="col-lg-4">
            <div class="card bg-pattern">
                <div class="card-body">
                    <div class="text-center">
                        <img src="/images/companies/airbnb.png" alt="logo" class="avatar-xl rounded-circle mb-3">
        ...
        <div class="col-lg-4">
            <div class="card bg-pattern">
                <div class="card-body">
                    <div class="text-center">
                        <img src="/images/companies/facebook.png" alt="logo" class="avatar-xl rounded-circle mb-3">
