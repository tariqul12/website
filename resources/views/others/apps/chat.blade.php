...
@section('content')
    ...
    <div class="container-fluid">
        ...
        @include('layouts.shared.page-title' , ['title' => 'Chat','subtitle' => 'Apps'])
                        ...
                        <div class="d-flex align-items-start mb-3">
                            ...
                            <div class="w-100">
                                <h5 class="mt-0 mb-0 font-15">
                                    <a href="{{ route('second', ['contacts', 'profile']) }}" class="text-reset">Geneva
                                        McKnight</a>
                                </h5>
                        ...
                        <div class="row">
                            <div class="col">
                                <div data-simplebar style="max-height: 375px;">
                                    ...
                                    <a href="javascript:void(0);" class="text-body">
                                        <div class="d-flex align-items-start p-2">
                                            <img src="/images/users/user-5.jpg"
                                                 class="me-2 rounded-circle" height="42" alt="James Z"/>
                                            <div class="w-100">
                                                <h5 class="mt-0 mb-0 font-14">
                                    ...
                                    <a href="javascript:void(0);" class="text-body">
                                        <div class="d-flex align-items-start p-2">
                                            <img src="/images/users/user-7.jpg"
                                                 class="me-2 rounded-circle" height="42" alt="Maria C"/>
                                            <div class="w-100">
                                                <h5 class="mt-0 mb-0 font-14">
                                    ...
                                    <a href="javascript:void(0);" class="text-body">
                                        <div class="d-flex align-items-start bg-light p-2">
                                            <img src="/images/users/user-10.jpg"
                                                 class="me-2 rounded-circle" height="42" alt="Rhonda D"/>
                                            <div class="w-100">
                                                <h5 class="mt-0 mb-0 font-14">
                                    ...
                                    <a href="javascript:void(0);" class="text-body">
                                        <div class="d-flex align-items-start p-2">
                                            <img src="/images/users/user-3.jpg"
                                                 class="me-2 rounded-circle" height="42" alt="Michael H"/>
                                            <div class="w-100">
                                                <h5 class="mt-0 mb-0 font-14">
                                    ...
                                    <a href="javascript:void(0);" class="text-body">
                                        <div class="d-flex align-items-start p-2">
                                            <img src="/images/users/user-6.jpg"
                                                 class="me-2 rounded-circle" height="42" alt="Thomas R"/>
                                            <div class="w-100">
                                                <h5 class="mt-0 mb-0 font-14">
                                                    <span class="float-end text-muted fw-normal font-12">Tue</span>
                                                    Thomas R
                                    ...
                                    <a href="javascript:void(0);" class="text-body">
                                        <div class="d-flex align-items-start p-2">
                                            <img src="/images/users/user-8.jpg"
                                                 class="me-2 rounded-circle" height="42" alt="Thomas J"/>
                                            <div class="w-100">
                                                <h5 class="mt-0 mb-0 font-14">
                                                    <span class="float-end text-muted fw-normal font-12">Tue</span>
                                                    Thomas J
                                    ...
                                    <a href="javascript:void(0);" class="text-body">
                                        <div class="d-flex align-items-start p-2">
                                            <img src="/images/users/user-4.jpg"
                                                 class="me-2 rounded-circle" height="42" alt="Ricky J"/>
                                            <div class="w-100">
                                                <h5 class="mt-0 mb-0 font-14">
                        ...
                        <div class="row justify-content-between py-1">
                            <div class="col-sm-7">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div>
                                        <h5 class="mt-0 mb-0 font-15">
                                            <a href="{{ route('second', ['contacts', 'profile']) }}"
                                               class="text-reset">James Zavel</a>
                                        </h5>
                        ...
                        <ul class="conversation-list" data-simplebar style="max-height: 460px;">
                            <li class="clearfix">
                                <div class="chat-avatar">
                                    <img src="/images/users/user-5.jpg" class="rounded"
                                         alt="James Z"/>
                                    <i>10:00</i>
                                </div>
                            ...
                            <li class="clearfix odd">
                                <div class="chat-avatar">
                                    <img src="/images/users/user-1.jpg" class="rounded"
                                         alt="Geneva M"/>
                                    <i>10:01</i>
                                </div>
                                <div class="conversation-text">
                            ...
                            <li class="clearfix">
                                ...
                                <div class="conversation-text">
                                    <div class="ctext-wrap">
                                        <i>James Z</i>
                                        <p>
                                            Sorry, I have another meeting scheduled at 2pm. Can we have it at 3pm
                                            instead?
                                        </p>
                                    </div>
                                </div>
