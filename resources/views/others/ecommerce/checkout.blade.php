...
@section('content')
    ...
    <div class="container-fluid">
        ...
        @include('layouts.shared.page-title' , ['title' => 'Checkout','subtitle' => 'Ecommerce'])
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-centered table-nowrap mb-0">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="/images/products/product-2.png" alt="product-img" title="product-img" class="rounded" height="48" />
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="/images/products/product-3.png" alt="product-img" title="product-img" class="rounded me-2" height="48" />
                                                    </td>
                                                    <td>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" id="card-name-on" class="form-control" placeholder="Master Ubold">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="mb-3">
...
@section('script')
    @vite('resources/js/pages/ecommerce-checkout.js')
@endsection
