...
@section('css')
    @vite(['node_modules/apexcharts/dist/apexcharts.css', 'node_modules/admin-resources/jquery.vectormap/jquery-jvectormap-1.2.2.css'])
@endsection
...
@section('content')
    ...
    <div class="container-fluid">
        ...
        @include('layouts.shared.page-title' , ['title' => 'Dashboard','subtitle' => 'Ecommerce'])
            ...
            <div class="col-xl-8">
                <div class="card">
                    <div class="card-body pb-2">
                        ...
                        <div id="revenue-chart" class="apex-charts mt-3" data-colors="#6658dd,#1abc9c" style="min-height: 363px !important;"></div>
                    </div>
                </div> <!-- end card -->
            </div> <!-- end col-->
                        ...
                        <div class="table-responsive">
                            <table class="table table-centered table-nowrap table-hover mb-0">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <img src="/images/users/user-2.jpg" alt="user-pic" class="rounded-circle avatar-sm bx-shadow-lg" />
                                    ...
                                    <tr>
                                        <td>
                                            <img src="/images/users/user-3.jpg" alt="user-pic" class="rounded-circle avatar-sm bx-shadow-lg" />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="/images/cards/american-express.png" alt="user-card" height="24" />
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img src="/images/cards/discover.png" alt="user-card" height="24" />
