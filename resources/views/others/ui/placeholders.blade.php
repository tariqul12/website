...
@section('content')
    ...
    <div class="container-fluid">
        ...
        @include('layouts.shared.page-title' , ['title' => 'Placeholders','subtitle' => 'UI'])
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-muted">In the example below, we take a typical card component and recreate it
                            with placeholders applied to create a “loading card”. Size and proportions are the same
                            between the two.</p>

                        <div class="row">
                            <div class="col-md-6">
                                <div class="card border shadow-none">
                                    <img src="/images/small/img-5.jpg"
                            ...
                            <div class="col-md-6">
                                <div class="card border shadow-none mb-0" aria-hidden="true">
                                    ...
                                    <img src="/images/small/img-3.jpg"
                                         class="card-img-top" alt="...">
                                    <div class="card-body">
            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-muted">Animate placehodlers with <code>.placeholder-glow</code> or <code>.placeholder-wave</code>
                            to better convey the perception of something being <em>actively</em> loaded.</p>
