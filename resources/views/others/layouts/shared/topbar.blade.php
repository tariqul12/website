    ...
    <div class="topbar">
        ...
        <ul class="topbar-menu d-flex align-items-center">
            ...
            <li class="app-search dropdown me-3 d-none d-lg-block position-static">
                ...
                <div class="dropdown-menu dropdown-menu-animated dropdown-lg" id="search-dropdown">
                    ...
                    <div class="notification-list">
                        ...
                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                            <div class="d-flex align-items-start">
                                <img class="d-flex me-2 rounded-circle" src="/images/users/user-5.jpg" alt="Generic placeholder image" height="32">
                                <div class="w-100">
            ...
            <li class="dropdown d-none d-md-inline-block">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated dropdown-lg p-0" style="position: absolute; inset: 0px 0px auto auto; margin: 0px; transform: translate(0px, 72px);" data-popper-placement="bottom-end">
                    <div class="p-2">
                        <div class="row g-0">
                            <div class="col">
