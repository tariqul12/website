...
@section('content')
    ...
    <div class="container-fluid">
        ...
        @include('layouts.shared.page-title' , ['title' => 'Form Advanced','subtitle' => 'Forms'])
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="sub-header">
                            Selectize is the hybrid of a textbox and <code>&lt;select&gt;</code> box. It's jQuery-based
                            and
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select multiple="multiple" class="multi-select" id="my_multi_select2"
                                        name="my_multi_select2[]" data-plugin="multiselect"
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="text-muted font-14 mb-3">
                            ...
                            Specify attribute <code>data-toggle="touchspin"</code> and your input would be conveterted
                            into
