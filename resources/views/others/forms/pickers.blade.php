...
@section('content')
    ...
    <div class="container-fluid">
        ...
        @include('layouts.shared.page-title' , ['title' => 'Form Pickers','subtitle' => 'Forms'])
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <button type="button" id="check-minutes"
                                                class="btn waves-effect waves-light btn-primary">Check the minutes
                                        </button>
                                    </div>
                                </div>
