@extends('layouts.vertical', ['title' => 'Material (Dashboard)', 'mode' => $mode ?? '', 'demo' => $demo ?? 'material'])
...
@section('content')
    ...
    <div class="container-fluid">
        ...
        @include('layouts.shared.page-title' , ['title' => 'Material','subtitle' => 'Demo'])
                        ...
                        <div class="todoapp">
                            ...
                            <form name="todo-form" id="todo-form" class="needs-validation mt-3" novalidate>
                                <div class="row">
                                    ...
                                    <div class="col-auto">
                                        <button class="btn-primary btn-md btn waves-effect waves-light w-100"
                        ...
                        <div class="chat-conversation">
                            ...
                            <form class="needs-validation" novalidate name="chat-form" id="chat-form">
                                <div class="row">
                                    ...
                                    <div class="col-auto">
                                        <button type="submit"
                                                class="btn btn-danger chat-send waves-effect waves-light w-100">Send
                                        </button>
                                    </div>
                                </div>
                            </form>
