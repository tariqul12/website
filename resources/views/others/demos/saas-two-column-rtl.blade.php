@extends('layouts.two-column', ['title' => 'Saas RTL (Two Column Layout)', 'mode' => $mode ?? 'rtl', 'demo' => $demo ?? 'saas', 'column_color' => $column_color ?? 'brand', 'rtl' => $rtl ?? 'rtl'])
...
@section('content')
    ...
    <div class="container-fluid">
        ...
        @include('layouts.shared.page-title' , ['title' => 'Saas','subtitle' => 'Demo'])
