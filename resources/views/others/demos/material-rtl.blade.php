@extends('layouts.vertical', ['title' => 'Material RTL (Dashboard)', 'mode' => $mode ?? 'rtl', 'demo' => $demo ?? 'material', 'rtl' => $rtl ?? 'rtl'])
                                ...
                                <ul class="conversation-list">
                                    <li class="clearfix">
                                        <div class="chat-avatar">
                                            <img src="/images/users/user-5.jpg" alt="male">
                                            <i>10:00</i>
                                        </div>
                                    ...
                                    <li class="clearfix odd">
                                        <div class="chat-avatar">
                                            <img src="/images/users/user-1.jpg" alt="Female">
                                            <i>10:01</i>
                                        </div>
                                        <div class="conversation-text">
                                            <div class="ctext-wrap">
                                    ...
                                    <li class="clearfix odd">
                                        <div class="chat-avatar">
                                            <img src="/images/users/user-1.jpg" alt="male">
                                            <i>10:02</i>
                                        </div>
                                        <div class="conversation-text">
                                            <div class="ctext-wrap">
...
@section('script')
    @vite(['resources/js/pages/dashboard-3.init.js'])
@endsection
