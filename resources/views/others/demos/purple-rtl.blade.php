@extends('layouts.vertical', ['title' => 'Purple RTL (Dashboard)', 'mode' => $mode ?? 'rtl', 'demo' => $demo ?? 'purple', 'topbar' => $topbar ?? 'brand', 'rtl' => $rtl ?? 'rtl'])
                        ...
                        <div class="table-responsive">
                            <table class="table table-borderless table-hover table-nowrap table-centered m-0">
                                ...
                                <tbody>
                                    <tr>
                                        <td style="width: 36px;">
                                            <img src="/images/users/user-2.jpg" alt="contact-img" title="contact-img" class="rounded-circle avatar-sm" />
                                        </td>
                                    ...
                                    <tr>
                                        <td style="width: 36px;">
                                            <img src="/images/users/user-3.jpg" alt="contact-img" title="contact-img" class="rounded-circle avatar-sm" />
                                        </td>
