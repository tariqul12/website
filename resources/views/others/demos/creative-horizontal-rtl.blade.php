@extends('layouts.horizontal', ['title' => 'Creative RTL (Horizontal Layout)', 'mode' => $mode ?? 'rtl', 'demo' => $demo ?? 'creative', 'rtl' => $rtl ?? 'rtl'])
...
@section('script')
    <script src="{{ Vite::asset('resources/js/pages/dashboard-2.init.js') }}"></script>
@endsection
