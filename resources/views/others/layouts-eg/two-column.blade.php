...
@section('content')
    ...
    <div class="container-fluid">
        ...
        @include('layouts.shared.page-title' , ['title' => 'Two Column','subtitle' => 'Layouts'])
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mt-3">
                            ...
                            <div class="progress progress-sm m-0">
                                <div class="progress-bar bg-secondary" role="progressbar" aria-valuenow="49"
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mt-3">
                            ...
                            <div class="progress progress-sm m-0">
                                <div class="progress-bar bg-primary" role="progressbar" aria-valuenow="18"
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mt-3">
                            ...
                            <div class="progress progress-sm m-0">
                                <div class="progress-bar bg-secondary" role="progressbar" aria-valuenow="74"
