...
<head>
    ...
    @vite(['node_modules/bootstrap/scss/bootstrap.scss','resources/scss/landing/app.scss', 'resources/scss/icons.scss'])
</head>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-4 offset-xl-2 col-lg-5 offset-lg-1 col-md-7">
                        <div class="home-img position-relative">
                            <img src="/images/landing/home-img.png" alt="" class="home-first-img">
                            <img src="/images/landing/home-img.png" alt="" class="home-second-img mx-auto d-block">
                            <img src="/images/landing/home-img.png" alt="" class="home-third-img">
                        </div>
                    </div>
                </div>
                <!-- end row -->
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="client-images">
                        <img src="/images/landing/clients/1.png" alt="logo-img" class="mx-auto img-fluid d-block">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="client-images">
                        <img src="/images/landing/clients/3.png" alt="logo-img" class="mx-auto img-fluid d-block">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="client-images">
                        <img src="/images/landing/clients/4.png" alt="logo-img" class="mx-auto img-fluid d-block">
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="client-images">
                        <img src="/images/landing/clients/6.png" alt="logo-img" class="mx-auto img-fluid d-block">
                    </div>
                </div>
            </div> <!-- end row -->
        </div>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="features-box">
                    <div class="features-img mb-4">
                        <img src="/images/landing/icons/layers.png" alt="">
                    </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="features-box">
                    <div class="features-img mb-4">
                        <img src="/images/landing/icons/core.png" alt="">
                    </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="features-box">
                    <div class="features-img mb-4">
                        <img src="/images/landing/icons/paperdesk.png" alt="">
                    </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="features-box">
                    <div class="features-img mb-4">
                        <img src="/images/landing/icons/solarsystem.png" alt="">
                    </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="features-box">
                    <div class="features-img mb-4">
                        <img src="/images/landing/icons/datatext.png" alt="">
                    </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="features-box">
                    <div class="features-img mb-4">
                        <img src="/images/landing/icons/browserscript.png" alt="">
                    </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="demo-box bg-white mt-4 p-2">
                    <a href="{{ route('any', 'index') }}" class="text-dark">
                        <img src="/images/landing/demo/layout-1.png" alt="" class="img-fluid mx-auto d-block">
                        <div class="p-3 text-center">
                            <h5 class="mb-0">Default (Vertical)</h5>
                            <div class="mt-2 text-center">
                                <a class="btn btn-success font-weight-bold btn-sm" href="{{ route('any', 'index') }}"
                                   target="_blank">Light</a>
                                <a class="btn btn-success font-weight-bold btn-sm"
                                   href="{{ route('second', ['demos', 'default-dark']) }}" target="_blank">Dark</a>
                            </div>
                        </div>
                    </a>
                </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="demo-box bg-white mt-4 p-2">
                    <a href="{{ route('second', ['demos', 'creative-horizontal']) }}" class="text-dark">
                        <img src="/images/landing/demo/layout-2.png" alt="" class="img-fluid mx-auto d-block">
                        <div class="p-3 text-center">
                            <h5 class="mb-0">Creative (Horizontal)</h5>
                            <div class="mt-2 text-center">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="demo-box bg-white mt-4 p-2">
                    <a href="{{ route('second', ['demos', 'material']) }}" class="text-dark">
                        <img src="/images/landing/demo/layout-3.png" alt="" class="img-fluid mx-auto d-block">
                        <div class="p-3 text-center">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="demo-box bg-white mt-4 p-2">
                    <a href="{{ route('second', ['demos', 'modern-detached']) }}" class="text-dark">
                        <img src="/images/landing/demo/layout-4.png" alt="" class="img-fluid mx-auto d-block">
                        <div class="p-3 text-center">
                            <h5 class="mb-0">Modern (Detached)</h5>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="demo-box bg-white mt-4 p-2">
                    <a href="{{ route('second', ['demos', 'purple']) }}" class="text-dark">
                        <img src="/images/landing/demo/layout-5.png" alt="" class="img-fluid mx-auto d-block">
                        <div class="p-3 text-center">
                            <h5 class="mb-0">Purple</h5>
                            <div class="my-2 text-center">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="demo-box bg-white mt-4 p-2">
                    <a href="{{ route('second', ['demos', 'saas-two-column']) }}" class="text-dark">
                        <img src="/images/landing/demo/layout-6.png" alt="" class="img-fluid mx-auto d-block">
                        <div class="p-3 text-center">
                            <h5 class="mb-0">Saas (Two-Column)</h5>
                            <div class="mt-2 text-center">
        ...
        <div class="row">
            <div class="col-12">
                <div class="text-center mt-4">
                    <a href="{{ route('any', 'index') }}" class="btn btn-info navbar-btn">More Demos <i class="mdi mdi-arrow-right"></i></a>
                </div>
            </div>
        </div>
        <!-- end row -->
...
<section class="section">
    <div class="container-fluid">
        ...
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="feature-img">
                    <img src="/images/landing/features-img/img-2.png" alt="" class="img-fluid mx-auto d-block">
                </div>
            </div>
            <div class="col-lg-6">
        ...
        <div class="row align-items-center mt-5">
            ...
            <div class="col-lg-6">
                <div class="feature-img">
                    <img src="/images/landing/features-img/img-1.png" alt="" class="img-fluid mx-auto d-block">
                </div>
            </div>
        </div>
        <!-- end row -->
...
<section class="section pb-0 bg-gradient" id="pricing">
    <div class="bg-shape">
        <img src="/images/landing/bg-shape.png" alt="" class="img-fluid mx-auto d-block">
    </div>
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-lg-6">
        ...
        <div class="row">
                ...
                <div class="testi-box mt-4">
                    ...
                    <div class="p-4">
                        <div class="testi-img float-start me-2">
                            <img src="/images/landing/testi/img-2.png" alt="" class="rounded-circle">
                        </div>
                        <div>
            ...
            <div class="col-lg-4">
                <div class="testi-box mt-4">
                    ...
                    <div class="p-4">
                        <div class="testi-img float-start me-2">
                            <img src="/images/landing/testi/img-1.png" alt="" class="rounded-circle">
                        </div>
                        <div>
            ...
            <div class="col-lg-4">
                <div class="testi-box mt-4">
                    ...
                    <div class="p-4">
                        <div class="testi-img float-start me-2">
                            <img src="/images/landing/testi/img-3.png" alt="" class="rounded-circle">
                        </div>
                        <div>
...
<section class="section pb-0 bg-gradient" id="contact">
    <div class="bg-shape">
        <img src="/images/landing/bg-shape-light.png" alt="" class="img-fluid mx-auto d-block">
    </div>
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
...
<!-- Back to top -->
<a href="#" class="back-to-top-btn btn btn-primary" id="back-to-top-btn"><i class="mdi mdi-chevron-up"></i></a>
