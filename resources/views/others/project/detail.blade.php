...
@section('content')
    ...
    <div class="container-fluid">
        ...
        @include('layouts.shared.page-title' , ['title' => 'Project Details','subtitle' => 'Projects'])
                ...
                <div class="card d-block">
                    <div class="card-body">
                        ...
                        <p class="text-muted mb-4">
                            ...
                            libero voluptas quod perferendis! Voluptate, quod illo rerum? Lorem ipsum dolor sit amet.
                        ...
                        <div id="tooltips-container">
                            <h5>Team Members:</h5>
                            <a href="javascript:void(0);" data-bs-container="#tooltips-container"
                    ...
                    <div class="card-body">
                        ...
                        <div class="mt-2">
                            <div class="d-flex align-items-start">
                                ...
                                <div class="w-100">
                                    <h5 class="mt-0"><a href="{{ route('second', ['contacts', 'profile']) }}"
                                                        class="text-reset">Jeremy Tomlinson</a> <small
                                            class="text-muted">3 hours ago</small></h5>
                                    ...
                                    <div class="d-flex align-items-start mt-3">
                                        ...
                                        <div class="w-100">
                                            <h5 class="mt-0"><a href="{{ route('second', ['contacts', 'profile']) }}"
                                                                class="text-reset">Kathleen Thomas</a> <small
                                                    class="text-muted">1 hours ago</small></h5>
                            ...
                            <div class="d-flex align-items-start mt-3">
                                ...
                                <div class="w-100">
                                    <h5 class="mt-0"><a href="{{ route('second', ['contacts', 'profile']) }}"
                                                        class="text-reset">Jonathan Tiner</a> <small class="text-muted">1
                                            day ago</small></h5>
                            ...
                            <div class="d-flex align-items-start mt-3">
                                <a class="pe-2" href="#">
                                    <img src="/images/users/user-1.jpg"
                                         class="rounded-circle" alt="Generic placeholder image" height="31">
                                </a>
                                <div class="w-100">
...
@section('script')
    @vite(['resources/js/pages/project-details.init.js'])
@endsection
