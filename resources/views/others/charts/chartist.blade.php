@extends('layouts.vertical', ['title' => 'time_nanosleep'])

@section('css')
    @vite(['node_modules/chartist/dist/index.css'])
@endsection
...
@section('content')
    ...
    <div class="container-fluid">
        ...
        @include('layouts.shared.page-title' , ['title' => 'Chartist Charts','subtitle' => 'Charts'])
...
@section('script')
    @vite(['resources/js/pages/chartist.init.js'])
@endsection
