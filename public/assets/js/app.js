...
class ThemeCustomizer {
    ...
    initLeftSidebar() {
        ...
        if ($(".menu").length) {
            ...
            $(".menu a").each(function () {
                ...
                var hrefPage = new URL(this.href).searchParams.get('page');
                if (pageParam === hrefPage) {              
    ...
    setSwitchFromConfig() {
        ...
        sessionStorage.setItem('__UBOLD_DEFAULT_CONFIG__', JSON.stringify(this.config));
        // localStorage.setItem('__UBOLD_DEFAULT_CONFIG__', JSON.stringify(this.config));
